...
public class ShapedDamageItemRecipe extends ExtendedShapedRecipe
{
	public static final Serializer<ShapedDamageItemRecipe> SERIALIZER = new Serializer<>(
			ShapedDamageItemRecipe::new,
	...
	public ShapedDamageItemRecipe(ShapedRecipe recipe)
	{
		super(recipe);
	}
