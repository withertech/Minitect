...
public class MineBlockTagProviderForge extends BlockTagsProvider
{
	public MineBlockTagProviderForge(DataGenerator arg, @Nullable ExistingFileHelper existingFileHelper)
	{
		super(arg, Minitect.MOD_ID, existingFileHelper);
	}
